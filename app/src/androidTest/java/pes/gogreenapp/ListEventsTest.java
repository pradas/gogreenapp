...
public class ListEventsTest {
    ...
    public void rewardHasTitle() {
        onView(withId(R.id.rv_events)).check(matches(hasDescendant(withId(R.id.eventTitle))));
    }
    ...
    public void rewardHasPoints() {
        ...
        onView(withId(R.id.rv_events)).check(matches(hasDescendant(withId(R.id.eventPoints))));
    }
    ...
    public void rewardHasCategory() {
        ...
        onView(withId(R.id.rv_events)).check(matches(hasDescendant(withId(R.id.eventCategory))));
    }
    ...
    public void rewardHasEndDate() {
        ...
        onView(withId(R.id.rv_events)).check(matches(hasDescendant(withId(R.id.eventEndDate))));
    }
    ...
    public void rewardHasHour() {
        ...
        onView(withId(R.id.rv_events)).check(matches(hasDescendant(withId(R.id.eventHour))));
    }
    ...
    public void rewardHasFavoriteButton() {
        ...
        onView(withId(R.id.rv_events)).check(matches(hasDescendant(withId(R.id.eventFavoriteButton))));
    }
    /**
     * Check if the card_view of the rewards_list have favorite button
     */
    ...
    public void rewardHasImage() {
        ...
        onView(withId(R.id.rv_events)).check(matches(hasDescendant(withId(R.id.eventImage))));
    }
    ...
    public void eachRewardInACardView() {
        ...
        onView(withId(R.id.rv_events)).check(matches(hasDescendant(withId(R.id.card_view_event))));
    }

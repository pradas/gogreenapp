...
public class ListDealsTest {
    ...
    public void setup() {
        ...
        try {
            ...
            onView(withId(R.id.nvView)).perform(NavigationViewActions.navigateTo(R.id.list_ofertas_fragment));
    ...
    public void showsAllEvents() {
        onView(withId(R.id.ofertas_list)).check(matches(isDisplayed()));
    }
    ...
    public void rewardHasTitle() {
        onView(withId(R.id.rv_ofertas)).check(matches(hasDescendant(withId(R.id.ofertaTitle))));
    }
    ...
    public void rewardHasPoints() {
        ...
        onView(withId(R.id.rv_ofertas)).check(matches(hasDescendant(withId(R.id.ofertaPoints))));
    }
    ...
    public void rewardHasEndDate() {
        ...
        onView(withId(R.id.rv_ofertas)).check(matches(hasDescendant(withId(R.id.ofertaEndDate))));
    }
    ...
    public void rewardHasFavoriteButton() {
        ...
        onView(withId(R.id.rv_ofertas)).check(matches(hasDescendant(withId(R.id.ofertaFavoriteButton))));
    }
    /**
     * Check if the card_view of the rewards_list have favorite button
     */
    ...
    public void rewardHasImage() {
        ...
        onView(withId(R.id.rv_ofertas)).check(matches(hasDescendant(withId(R.id.ofertaImage))));
    }
    ...
    public void eachRewardInACardView() {
        ...
        onView(withId(R.id.rv_ofertas)).check(matches(hasDescendant(withId(R.id.card_view_oferta))));
    }
    ...
    public void clickInRewardGoesToRewardDetail() {
        ...
        onView(withId(R.id.rv_ofertas)).perform(RecyclerViewActions.actionOnItemAtPosition(0, click()));
